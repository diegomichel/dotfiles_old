...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "[_T_]", "2", "3", "4", "VM", 6, 7, 8, 9 }, s, layouts[1])
end
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ },"XF86PowerOff", function () awful.util.spawn("pm-suspend", false) end),
    ...
    awful.key({ },"XF86HomePage", function () awful.util.spawn("firefox-bin", false) end)
)
